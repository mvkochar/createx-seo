...
const Footer = () => {
  return (
    <footer className='footer'>
      <div className="d-f jc-sb">
        ...
        <div>
          ...
          <ul className="footer-bl-list">
            ...
            <li><a href="" className='text-uppercase'>Seo</a></li>
        ...
        <div>
          <h4 className="footer-bl-title">Contact us</h4>
          <ul className="footer-bl-list">
            <li className='footer-phone'>(405) 555-0128</li>
            <li className='footer-email'>hello@createx.com</li>
          </ul>
        </div>
        <div>
          <h4 className="footer-bl-title">Sign up to our newsletter</h4>
          <form action="" className="footer-bl-fm d-f jc-sb align-center">
            <input type="email" name="newsletterEmail" placeholder='Email address' />
            <button type="button" className='btn-clear d-b' >
              <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.86193 0.529247C8.12228 0.268897 8.54439 0.268897 8.80474 0.529247L11.8047 3.52925C12.0651 3.7896 12.0651 4.21171 11.8047 4.47206L8.80474 7.47206C8.54439 7.73241 8.12228 7.73241 7.86193 7.47206C7.60158 7.21171 7.60158 6.7896 7.86193 6.52925L9.72386 4.66732H0.666667C0.298477 4.66732 0 4.36884 0 4.00065C0 3.63246 0.298477 3.33398 0.666667 3.33398H9.72386L7.86193 1.47206C7.60158 1.21171 7.60158 0.789596 7.86193 0.529247Z" fill="white" />
              </svg>
            </button>
          </form>
          <p className="footer-bl-note">
      ...
      <div className="d-f jc-sb">
        <div><img src="/images/awards.png" alt="awards" /></div>
        <div className="footer-go d-f">
          <p className="footer-go-name">Go to top</p>
          <button className='footer-go-btn' onClick={() => window.scroll({ top: 0, behavior: 'smooth' })}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="footer-copyrights d-f align-center">  
        ...
        <p>Made with by Createx Studio</p>
      </div>
    </footer>
  )
}
